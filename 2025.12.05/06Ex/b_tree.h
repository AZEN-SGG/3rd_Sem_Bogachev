...
class b_tree
{
	...
	public:
		...
		// Solve 2
		static t_count get_number_elem_in_subtrees_with_less_k_nodes (const b_tree_node<T> *curr, const int k);

		// Solve 3
		static int get_depth_subtree (const b_tree_node<T> *curr);
		static int get_number_elem_in_subtrees_with_less_k_levels (const b_tree_node<T> *curr, const int k, const int level);
		
		// Solve 4
		static int get_number_nodes_on_level_subtree (const b_tree_node<T> *curr, const int level);
		static t_count get_number_elem_in_subtrees_with_less_k_nodes_in_level (const b_tree_node<T> *curr, const int k, int &count, const int depth);

		// Solve 5
		static int get_number_elem_on_level_subtree (const b_tree_node<T> *curr, const int level);

		// Solve 6
		static int get_number_elem_in_subtree (const b_tree_node<T> *curr);
